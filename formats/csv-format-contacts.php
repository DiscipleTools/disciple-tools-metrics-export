<?php
/**
 * Export Format: CSV export of Contacts
 *
...
if ( defined( 'ABSPATH' ) ) {
    /**
     * Class DT_Metrics_Export_CSV_Contacts
     */
    class DT_Metrics_Export_CSV_Contacts
    {
        ...
        public function format( $format ) {
            ...
            $format[$this->token]['types'] = [
                'contacts' => [
                    ...
                    'lnglat' => [
                        'key' => 'lnglat',
                        'label' => 'All contacts with a row for each location. This can have duplicates if the contact has multiple locations. Fields: [name, status, lng, lat, email, phone]'
                    ],
                ],
            ];
            return $format;
